  ...
  public CardDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCard = new EntityInsertionAdapter<Card>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `cards` (`id`,`title`,`content`,`summary`,`type`,`source`,`tags`,`createdAt`,`updatedAt`,`language`,`aiModel`,`summaryType`,`thumbnailUrl`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfCard = new EntityDeletionOrUpdateAdapter<Card>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `cards` SET `id` = ?,`title` = ?,`content` = ?,`summary` = ?,`type` = ?,`source` = ?,`tags` = ?,`createdAt` = ?,`updatedAt` = ?,`language` = ?,`aiModel` = ?,`summaryType` = ?,`thumbnailUrl` = ? WHERE `id` = ?";
      }
      ...
      public List<Card> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Card(_tmpId,_tmpTitle,_tmpContent,_tmpSummary,_tmpType,_tmpSource,_tmpTags,_tmpCreatedAt,_tmpUpdatedAt,_tmpLanguage,_tmpAiModel,_tmpSummaryType,_tmpThumbnailUrl);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Card call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Card(_tmpId,_tmpTitle,_tmpContent,_tmpSummary,_tmpType,_tmpSource,_tmpTags,_tmpCreatedAt,_tmpUpdatedAt,_tmpLanguage,_tmpAiModel,_tmpSummaryType,_tmpThumbnailUrl);
          } else {
            _result = null;
          }
          return _result;
